      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            ...
            <h3 className="resume-title">{t("resume", "skills")}</h3>
            {Array.from(skills).map((sk, i) => (
              <div className="resume-item" key={i}>
                <h4>{sk.title[lang]}</h4>
                {sk.items[lang].map((it, j) => (
            ...
            <h3 className="resume-title">{t("resume", "exams")}</h3>
            {Array.from(exams).map((ex, i) => (
              <div className="resume-item" key={i}>
                <h4>{ex.title[lang]}</h4>
                <h5>{ex.result[lang]}</h5>
              </div>
            ))}
          </div>
        </div>
