      ...
      <div className="about-me container">
        ...
        <div className="row">
          ...
          <div className="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <p className="fst-italic">{about.bio[lang]}</p>
            <div className="row" style={{ overflowX: "auto" }}>
              <div className="col-lg-6">
                <ul>
                  ...
                  <li>
                    <i className="bi bi-chevron-right" />{" "}
                    <strong>{t("about", "phone")}</strong> <span>{contact_links.phone}</span>
                  </li>
                  <li>
                    <i className="bi bi-chevron-right" /> <strong>{t("about", "city")}</strong>{" "}
              ...
              <div className="col-lg-6">
                <ul>
                  <li>
                    <i className="bi bi-chevron-right" /> <strong>{t("about", "age")}</strong>{" "}
                    <span>{about.age}</span>
                  </li>
                  <li>
                    <i className="bi bi-chevron-right" />{" "}
                    <strong>{t("about", "degree")}</strong> <span>{about.degree}</span>
                  </li>
                  <li>
                    <i className="bi bi-chevron-right" />{" "}
                    <strong>{t("about", "email")}</strong> <span>{contact_links.email}</span>
                  </li>
                </ul>
              </div>
            </div>
            <p>{about.longBio[lang]}</p>
          </div>
        </div>
      </div>
            ...
            <div className="col-lg-6" key={i}>
              <div className="progress">
                <span className="skill">
                  {skill.title[lang]} <i className="val">{skill.value}%</i>
                </span>
